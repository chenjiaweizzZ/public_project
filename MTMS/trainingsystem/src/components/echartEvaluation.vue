<template>
  <div
    ...
    id="chartCon"
    style="position:absolute;z-index:50;top:0;left:0;width:100%;padding-bottom:20px;"
  >
    ...
    AllData: {
      handler(newVal, oldVal) {
        ...
        if (!newVal || newVal.length === 0) {
          ...
          obj = this.processingBarData(newVal);
        }
  ...
  methods: {
    processingBarData(data) {
      ...
      for (let value of data) {
        let hund = parseFloat(value.totalscore); //hundredmarksystem

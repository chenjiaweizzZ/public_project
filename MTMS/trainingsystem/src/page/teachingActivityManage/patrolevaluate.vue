<template>
    <div class="wapper patrolevaluate">
        <div class="tools">
            <div class="funcTools">
        ...
        <div class="queryTools graduationQueryTools">
            ...
            <el-form ref="queryForm" label-width="50px" :model="queryForm">
                <div class="queryTeacgingWrap">
                    <el-form-item label="科室" prop="" style="width: 250px;" class="hosDeptBox">
                    ...
                    <el-form-item label="评分日期" style="width: 295px;" label-width="70px">
                        <el-date-picker v-model="queryForm.dateArr" type="monthrange" range-separator="至" start-placeholder="选择日期" end-placeholder="选择日期"></el-date-picker>
                    </el-form-item>
        ...
        <div class="dataTable">
            <el-table ref="detailTable" border :data="dataList" tooltip-effect="dark" style="width: 100%" v-loading.body="loading" @selection-change="handleSelectionChange"
                ...
                <el-table-column prop="deptname" label="科室名称" width="120" fixed='left'>
                ...
                <el-table-column prop="name" width="120" label="科秘书">
                    <template slot-scope="scope">
                        <div class="actionplansty">
                ...
                <el-table-column prop="advise" min-width="120" label="意见和建议">
                    <template slot-scope="scope">
                        <div class="actionplansty">
                ...
                <el-table-column prop="teachername" width="110" label="评分人">
                    <template slot-scope="scope">
                        <div class="actionplansty">
    ...
    export default {
        ...
        methods: {
            ...
            removeNode(e) {
                ...
                response.forEach(item => {
                    if (e != item.name) {
                        ...
                        this.queryForm.doctoroffice.push(item.id)
                ...
                this.$refs.tree.setCheckedKeys(this.queryForm.doctoroffice);
            },
            ...
            setQueryFormOne(form) {
                ...
                this.queryForm.doctoroffice = form.deptId
...
<style>
    .patrolevaluate .queryTools .el-date-editor--monthrange {
        width: 215px;
    }
</style>
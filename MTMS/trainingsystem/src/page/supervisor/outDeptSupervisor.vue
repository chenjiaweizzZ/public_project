    ...
    <el-table :data="tableData" border>
      ...
      <el-table-column prop="date" label="督导时间" width="300">
        <template slot-scope="scope">
          <p><img src="../../assets/images/icon-time.svg" style="margin-right: 6px;vertical-align:-2px">{{scope.row.date}}&nbsp;{{scope.row.startTime}}-{{scope.row.endTime}}</p>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="supervisorExpertDTOS" label="督导专家评分">
        <template slot-scope="scope">
      ...
      <el-table-column prop="feedbackExpertNames" label="科室反馈" width="150">
        <template slot-scope="scope">
          <div class="cellButton">
      ...
      <el-table-column prop="address" label="附件" width="120px">
        <template slot-scope="scope">
...
<style>
  .outDeptSupervisor .el-date-editor {
    width: 125px;
  }

  .outDeptSupervisor .el-pagination {
    text-align: right;
    margin-top: 20px;
  }

  .outDeptSupervisor .el-transfer-panel {
    width: 300px;
  }

  .outDeptSupervisor .el-transfer__buttons .el-button {
    margin-left: 0;
  }

  .outDeptSupervisor .addSupervisor .el-dialog {
    width: 820px;
  }

  .outDeptSupervisor .addSupervisor .el-date-editor {
    width: 335px;
  }

  .outDeptSupervisor .addSupervisor .el-form-item {
    width: fit-content;
  }
</style>
<style scoped>

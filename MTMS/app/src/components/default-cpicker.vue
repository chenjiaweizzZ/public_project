<template>
    <transition enter-active-class="animated fadeIn" leave-active-class="animated fadeOut" >
        <div id="picker" v-show="config.show" @click="shadow($event)">
            <div id="picker-main">
                <header>
                ...
                <section>
                    <!--<div class="all">-->
                        <!--<p></p>-->
                        <!--&lt;!&ndash;<p :class="{'active':allSelect}" @click="allSelectFn">全部</p>&ndash;&gt;-->
                    <!--</div>-->
                    <div class="on"></div>
...
<script>
    export default {
            ...
            'config.mainlist':function(val,oldval){
                if(val !== oldval){
                    ...
                    if(this.config.mainlist[0].childlist&&this.config.mainlist[0].childlist.length>0){
                        ...
                        if(this.isAll){
                            this.childlist.unshift({deptname:'全部'});
                        }
        ...
        methods:{
            ...
            shadow(event){
                if(event.target.getAttribute('id')=='picker'){
            ...
            sure(){
                ...
                if(!this.acceptable){
                    ...
                    let deptname=this.config.mainlist[this.activeItem].childlist[this.activeItem2].deptname;
                    let id=this.config.mainlist[this.activeItem].childlist[this.activeItem2].id;
                    this.$emit('confirm',{deptname:deptname,deptid:id})//传给父组件
                }

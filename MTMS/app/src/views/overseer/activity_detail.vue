            ...
            <div class="teachingPlan-detail">
                ...
                <div class="activeTime">
                    ...
                    <div class="timeBox" v-if="detail.showTime && detail.showTime.length > 0">
                        <div class="boxItem" v-for="(item,index) in detail.showTime" :key="indx">
                            <p>{{item.date}}</p>
                ...
                <div class="baseInfo psinfo otherFils" v-if="detail.fileuploadlist && detail.fileuploadlist.length>0">
                    ...
                    <p v-for='(val,index) in detail.fileuploadlist' class="otherItem" @click="dowmload(fdfsurl + '/' + val.fileurl,val.filename)">{{val.filename}}</p>
                </div>
                <div class="baseInfo psinfo otherFils" v-if="videolist.length > 0">
                    ...
                    <a target="_blank" href="javascript:void(0)" class="otherItem" v-for='(val,index) in videolist' @click="vedioOpen(val)">{{val.filename}}</a>
                </div>
            </div>
            ...
            update() {//修改
                ...
                this.$router.push({
                    ...
                    query: {
                        ...
                        isOverseer: self.$route.query.isOverseer,

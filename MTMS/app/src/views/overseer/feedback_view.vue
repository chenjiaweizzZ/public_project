<template>
  <div class="supervise-grade">
    <van-nav-bar title="查看反馈" left-arrow @click-left="back"></van-nav-bar>
    <div class="g-main">
      <div class="header">
        <div>
      ...
      <div class="ggrade" v-if="type == 1">
        <div class="ggg">
          ...
          <div class="ggg-last">反馈评分：{{ score }}</div>
        </div>
        <div
          class="ttt"
        >反馈人：{{evaluator}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;评价时间：{{ submitTime }}</div>
      </div>
      ...
      <div class="nodata" v-else>
        ...
        <div v-if="description" class="nodataText">科室暂无反馈</div>

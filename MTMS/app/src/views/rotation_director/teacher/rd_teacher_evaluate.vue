<template>
    <div class="g-wrapper" @click='close'>
        <c-header>
            ...
            评分
            <div slot='headerRight' style="font-size: 0.3rem;" :class="{noclick:issubmit}" @click='submit'>提交</div>
        </c-header>
        ...
        <div class="g-main" v-if='!noContent'>
            ...
            <!--</div>-->
            <h1>{{title}}</h1>
            <p class="tip">此问卷为各位护培生师日常考核所用，并存入护培学档案，请大家认真填写。</p>
            ...
            <div class="evaluate">
                <h4><span style="color: red;">*</span> 护培生师优点（必填）</h4>
                <textarea v-model='advantage'  @focus='textareaFocus' @blur='textareaBlur'></textarea>
                <h4><span style="color: red;">*</span> 对进一步成长的建议（必填）</h4>
                <textarea v-model='advise' @focus='textareaFocus' @blur='textareaBlur'></textarea>
                <!--<h4>关于此次评估我已经给予该护培生师反馈</h4>-->
                <!--<div class="footer">-->
        ...
        methods: {
            ...
            init() {
                ...
                if(self.$route.query.message){
                    options.evaluatedid = self.$route.query.id
                }else {
                    options.evaluatedid = this.turninfo.stuid
                }
            ...
            submit() {
                ...
                if(self.$route.query.message){
                    ...
                    options.evaluatedid = self.turninfo.stuid
                    options.businessid = self.turninfo.businessid
                }
                // self.month = '2016.1.1'
                self.checklist = []

<template>
    <div class="g-wrapper">
        <p class="search" @click="gettime.show = true">
            <span>日期</span>
            <i class="icon"></i>
        </p>
        <div class="g-main" >
            <div v-for='item in turndoctors' class="list" v-if='!nocontent'>
                <ul>
                    ...
                    <li>
                        <span>专业基地：{{item.proname}}</span>
                    </li>
                    <li>
                        <span>带教老师：{{item.tecname}}</span>
                    </li>
                    <li>
                        <span>培 训 期 ：{{item.starttimestr | checkdate}}-{{item.endtimestr | checkdate}}</span>
                    </li>
                    <li>
                ...
                <div class="footerBtn">
                    <a @click='dailyExam(item.detailid,item.stdid)'>考核查看</a>
                </div>
            </div>
            <!--选择时间-->
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            init(param) {
                let self = this
                self.post('/turn/listteachingrecord', {

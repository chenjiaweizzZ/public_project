<template>
  <div class="g-wrapper">
    <c-header>
      ...
      <div slot="headerRight" class="looktable" @click="tohistory">查看历史</div>
    </c-header>
      ...
      self
        ...
        .done(function(data) {
          if (data && data.errcode == 0) {
            ...
            if (self.$route.query.back == 1 || self.$route.query.deptid) {
      ...
      self.post("/base/dept/getMyDeptTree", {
        ...
        if(res && res.resCode == 200) {
          if(Array.isArray(res.model) && res.model.length > 0) {
            ...
            // self.titledeptid = res.model[0].childrens[0].id
            // this.$refs.tree.setCheckedKeys(self.orideptnameidList);
            self.init()
          }
        }

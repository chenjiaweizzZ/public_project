                ...
                <template>
                    <div class="rotationContent" v-if="showdetail">
                        ...
                        <div class="rotation_person">
                            <p class="t-right">
                                <span>科室主任：<i v-for="(item,index) in messages.directorlist">{{item.name}}&emsp;</i></span>
                            </p>
                            <p>
                                <span>科室秘书：<i v-for="(item,index) in messages.secretarylist">{{item.name}}&emsp;</i></span>
                            </p>
                        ...
                        <ul>
                            <li><span>轮转周期：{{messages.begintime}}-{{messages.endtime}}</span></li>
                        ...
                        <div class="enter" v-if='messages.turnstatus != 0'>
                            <a @click='enter(messages.plandetailid,messages.endtime)'>点击进入</a>
                        </div>
                    </div>
    ...
    window.location.href =
        "/pages/futuredoctorapp/index.html/#/wxIndex";
            ...
            progress: function () {
                ...
                let resultwidth = grayBarWidth * self.messages.progress > grayBarWidth ? grayBarWidth : grayBarWidth * self.messages.progress;
                greenBar.css({

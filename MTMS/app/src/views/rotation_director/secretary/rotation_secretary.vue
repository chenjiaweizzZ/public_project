<template>
  <div class="g-wrapper">
    ...
    <c-tabs :bus="bus" @change-tab="changeTab">
      ...
      <c-tab title="已轮转" :active="type == 5" :bus="bus" data="5"></c-tab>
    </c-tabs>
    <div class="g-main">
      <div v-show="type == 1">
        <rotation-ready
      ...
      <div v-show="type == 3">
        <rotation-notturn :active="type == 3" :titledeptid="titledeptid" :deptname="deptname"></rotation-notturn>
      </div>
      <div v-show="type == 5">
        <rotation-already
          :active="type == 2"
    ...
    initdeptname() {
      ...
      self
        .post("/deptinfo/getusermanagerdeptinfoforsysrole", {
          ...
          rolelist: [3] //科秘：[2]//科主任：[3]//实习秘书:[1]//>管理者:[6, 7, 8] |
        })
        .done(function(data) {
          if (data && data.errcode == 0) {

<template>
  <div class="g-main">
    <div v-for="item in turndoctors" class="list">
      ...
      <div class="footerBtn">
        <van-button size="small" type="info" @click="proving(item)" :disabled="!item.evaluable">日常评价</van-button>
        <!-- <a @click="proving(item)">日常评价</a> -->
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    init() {
      let self = this;
      self
        .post("/turnedoctormain/getnotevaluateforheadnurse", {
    ...
    proving(param) {
      let self = this;
      self
        .post("/turnevaluate/validateEvaluate", {

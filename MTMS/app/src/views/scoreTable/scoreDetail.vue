<template>
  <div class="supervise-grade">
    <div class="g-main">
        ...
        <div v-for="(item,index) in gradeList" class="grade-box" :key="index">
          ...
          <div v-for="(iten,indey) in item.questionList" class="content-box" :key="indey">
            ...
            <div v-if="iten.type == 1">
              <van-radio-group v-model="iten.save" disabled>
            ...
            <div v-if="iten.type == 6"  class="dx">
              <div class="scorll-item">
                <van-slider v-model="iten.answerScore" :step="0.5" min="0" :max="iten.score" disabled/>
                <span style="width: 20px"></span>
                <van-stepper v-model="iten.answerScore" min="0" :max="iten.score" step="0.5" disable-input disabled/>
              </div>
                <van-field
      ...
      <div v-if="type == 0" style="height:100px;background: #fff;"></div>
    </div>

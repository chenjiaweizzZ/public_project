<template>
    <div class="g-wrapper">
      <c-header>
          ...
          <div slot='headerRight' style="font-size: 0.3rem;" :class="{noclick:issubmit}"  @click.stop="submit" v-if="$route.query.type==1&&jb_status===0">提交</div>
          <div slot='headerRight' style="font-size: 0.3rem;" :class="{noclick:issubmit}"  @click.stop="submitJb" v-if="$route.query.type==2" >提交</div>
        </c-header>
        <!--文字内容-->
            ...
            <div class="submissions training_Situation">
                <h3 class="base">以下内容需要学员填写</h3>
                 <div class="trainingItem">
                    ...
                    <div class="num">
                        ...
                        <div class="fillWrap">
                            <p class="yes"><input type="radio" class="radio"  :checked="speciallectureflag"  v-model="speciallectureflag" :value=1 disabled="disabled"><label
                                for="">是</label>
                            </p>
                            <p class="none">
                                <input type="radio" class="radio" v-model="speciallectureflag" :value=0 :checked="speciallectureflag"  disabled="disabled"><label
                                for="">否</label>
                            </p>
                        </div>
                    </div>
                ...
                <div class="trainingItem training_Situation_Item">
                    ...
                    <div class="num">
                        <p>旷工天数</p>
                        <p><input type="number" class="commonText minersText" v-model="absenteeismdays"  disabled="disabled"></p>
                    </div>
                </div>
                <div class="trainingItem training_Situation_Item">
                    ...
                    <div class="num">
                        <p>医疗事故（要求“无”）</p>
                        <div class="fillWrap">
                            <p class="yes"> <input type="radio" class="radio" v-model="malpracticeflag" :value=1  disabled="disabled"><label for="">有</label></p>
                            <p class="none"> <input type="radio" class="radio" v-model="malpracticeflag" :value=0 disabled="disabled"><label for="">无</label></p>
                        </div>
                    </div>
                </div>
                <div class="trainingItem training_Situation_Item">
                    ...
                    <div class="num">
                        <p>医疗纠纷和投诉（次数）</p>
                        <p><input type="number" class="minersText" v-model="medicaldisputescounts" disabled="disabled"></p>
                    </div>
                </div>
                 <div class="trainingItem training_Situation_Item">
                    ...
                    <div class="num">
                        ...
                        <div class="fillWrap">
                            <p class="yes"> <input type="radio" class="radio" v-model="clinicaloperationflag" :value=1  disabled="disabled"><label for="">是</label></p>
                            <p class="none"> <input type="radio" class="radio"  v-model="clinicaloperationflag" :value=0 disabled="disabled"><label for="">否</label></p>
                        </div>
                    </div>
                </div>
                <div class="trainingItem training_Situation_Item">
                    <div class="trainingName publish statisticalSign">
                        <div class="num statistical">
                            ...
                            <div class="info">
                                <div class="textwrap">
                                    <textarea class="academic_Text descpdetail descpdetailSign" name="academic_Text" :maxlength="300"></textarea>
                                </div>
                            </div>
                                <vue-uploader :isupload="false" ref="add_picture1" class="add_picture" :fdfsurl="fdfsurl" :imgList='imgList[0]'></vue-uploader>
                        </div>
                    </div>
                ...
                <div class="trainingItem training_Situation_Item">
                    <div class="trainingName  publish statistical statisticalSign">
                        <div class="num statistical">
                            ...
                            <div class="info">
                                <div class="textwrap">
                                      <textarea class="descpdetail descpdetailSign" :maxlength="300"></textarea>
                                </div>
                            </div>
                                    <vue-uploader :isupload="false" ref="add_picture2" class="add_picture" :fdfsurl="fdfsurl" :imgList='imgList[1]'></vue-uploader>
                        </div>
                    </div>
                </div>
                <div class="trainingItem training_Situation_Item">
                        ...
                        <div class="num publish statistical">
                            ...
                            <div class="info">
                                <div class="textwrap">
                                    ...
                                    <vue-uploader :isupload="false" ref="add_picture3" class="add_picture" :fdfsurl="fdfsurl" :imgList='imgList[2]'></vue-uploader>
                        </div>
                    </div>
                 ...
                 <div class="trainingItem training_Situation_Item">
                    <div class="trainingName publish statistical statisticalSign">
                        ...
                        <div class="num publish statistical">
                            ...
                            <div class="info">
                                <div class="textwrap">
                                                            <textarea class="descpdetail descpdetailSign"  disabled="$route.query.stdstatus==5 ? true : false" :maxlength="300"></textarea>
                                </div>

                            </div>
                                    <vue-uploader :isupload="false" ref="add_picture4" class="add_picture" :fdfsurl="fdfsurl" :imgList='imgList[3]'></vue-uploader>
                        </div>
                    </div>
                            ...
                            <p> <label for="">17：</label>:惩罚情况</p>
                             <div class="info">
                                 <div class="textwrap">
                                    ...
                                    <vue-uploader :isupload="false" ref="add_picture5" class="add_picture" :fdfsurl="fdfsurl" :imgList='imgList[4]'></vue-uploader>
                        </div>
                    </div>
                ...
                <!--16、执业医师通过情况-->
                <div class="trainingItem training_Situation_Item">
                    <div class="trainingName"><label for="">18：</label></div>
                    <div class="num">
                        <p>执业医师通过情况</p>
                        <div class="fillWrap">
                            <p class="yes"> <input type="radio" class="radio" v-model="practitionerflag"  :value=1  disabled="disabled"><label for="" >是</label></p>
                            <p class="none"> <input type="radio" class="radio" v-model="practitionerflag" :value=0  disabled="disabled" >
                                <label for="">否</label></p>
                        </div>
                        <div class="certificateNumber" :class="{ngActive:practitionerflag===1 ? true:false}">
                            <label for="">医师资格证书号:</label><input type="text" class="certificateNumberText" v-model="practitionercode"  disabled="disabled">
                        </div>
                    </div>
                </div>
                <div class="identification ">
                    ...
                    <div class="trainingItem identificationText">
                        <div class="num">
                            ...
                            <div class="info">
                                 <div class="textwrap">
                                         <textarea  name="" id="" cols="30"  v-model="stdcontent" class="descpdetail" :maxlength="300"></textarea>
                                 </div>
                ...
                <!--基地鉴定-->
                <div class="identification jd_wrap_sign" v-show="$route.query.type==1||$route.query.type==2">
                    <div class="base">
                        <span>专业基地鉴定 </span>
                          <div class="fillWrap jd_radio">
                            <p class="yes"> <input type="radio" class="radio" name="jdradio" :value=10 v-model="jdradio_status"><label for="" >通过</label></p>
                            <p class="none"> <input type="radio" class="radio" name="jdradio" :value=5 v-model="jdradio_status"><label for="" >不通过</label></p>
                        </div>
                    </div>
                    <div class="trainingItem identificationText" >
                        <div class="num">
                            <div class="info">
                                <div class="textwrap">
                                    <textarea maxlength="300" name="" id="" cols="30"  placeholder="可填写相关鉴定说明"
                                              v-model="jd_content" class="jd_info" @focus='textareaFocus'
                                              @blur='textareaBlur'>{{jd_content}}</textarea>
                                </div>
                            </div>
                ...
                <!--教办-->
                 <div class="identification" v-show="jd_status!=0&&$route.query.type==2">
                    <div class="base">
                        <span> 教学办公室/护培办公室  </span>
                          <div class="fillWrap jb_radio">
                            <p class="yes"> <input type="radio" class="radio" name="jbradio" :value="10" v-model="jbradio_status"><label for="">通过</label></p>
                            <p class="none"> <input type="radio" class="radio" name="jbradio" :value="5" v-model="jbradio_status"><label for="">不通过</label></p>
                        </div>
                    </div>
                    <div class="trainingItem identificationText">
                        <div class="num">
                            <div class="info">
                                <div class="textwrap">
                                    <textarea   :maxlength="300" @blur='textareaBlur'  @focus='textareaFocus' name="" id=""  class="jb_info" v-model="jb_content"></textarea>
                                </div>
    ...
    export default {
        ...
        methods:{
            ...
            //设置文本域
             setTextArea(data){
                 ...
                 for (let i = 0; i < textareaDom.length; i++) {
                     if(this.$route.query.stdstatus==5){
                         textareaDom[i].setAttribute('disabled',true);
                     }
            ...
            getSubmitInit(){
                 ...
                 self.post('/turnedoctormain/personalevasubinit', {
                    ...
                    //初始化数据
                    let res=data.bean;
                    self.stuData.turndoctorinfobean = res.turndoctorinfobean;
                    self.stuData.turndoctortraininfobean = res.turndoctortraininfobean;
                    self.stuData.turndoctorassessmentbean = res.turndoctorassessmentbean;
                    ...
                    self.fdfsurl=data.fdfsurl;
                    self.jd_status=self.jdradio_status=res.turnpersonalevaluatebean.basestatus;
                    self.jd_content=res.turnpersonalevainfobean.basecontent;
                    self.jb_status=self.jbradio_status=res.turnpersonalevaluatebean.teachofficestatus;
                   ...
                   //文本框的自动收缩;
                     ...
                     if(this.$route.query.type==1){
                         if (self.jb_status !== 0) {
                             $(".jd_radio input").add(".jd_info").attr("disabled", 'disabled');
                         } else {
                             $(".jd_radio input").add(".jd_info").removeAttr("disabled");
                         }
                     }

                     $(".jb_radio input").add(".jb_info").removeAttr("disabled");
                 });
            },
            textResize(){
            ...
            submitJb(){
                 let self=this;
                 if(self.jbradio_status==''){
                     self.toast("请填写通过或不通过");
                 }else if($.trim(self.jb_content)==''||$.trim(self.jb_content)==null){
                     self.toast("请填写相关鉴定说明");
                 }else{
                         self.post('/turnedoctormain/teachofficepersonalevastatussub', {
                             command: "turnedoctormain/teachofficepersonalevastatussub",
                             sessionid: $.cookie('sid'),
                             loginid: $.cookie('uid'),
                             id: this.$route.query.id,
                             type: 3,
                             status: self.jbradio_status,
                             yearflag: this.$route.query.yearflag,
                             content:self.jb_content
                         }).done((data) => {
                             if (data.errcode == '0') {
                                 self.toast("提交成功");
                                 self.$router.push({
           ...
           textareaFocus(){
            ...
            submit(){
                 let self=this;
                 if(self.jdradio_status==''){
                     self.toast("请填写通过或不通过");
                 }else if($.trim(self.jd_content)==''||$.trim(self.jd_content)==null){
                      self.toast("请填写相关鉴定说明");
                 }
                 else{
                         self.post('/turnedoctormain/basepersonalevastatussub', {
                             command: "turnedoctormain/basepersonalevastatussub",
                             sessionid: $.cookie('sid'),
                             loginid: $.cookie('uid'),
                             id: this.$route.query.id,
                             type: 2,
                             status: self.jdradio_status,
                             yearflag: this.$route.query.yearflag,
                             content:self.jd_content
                         }).done((data) => {
                             if (data.errcode == '0') {
                                 self.toast("提交成功");
                                 self.$router.push({
        ...
        mounted(){
            ...
            if(this.$route.query.type==2){
                    // $(".jd_wrap_sign").find("input").add("textarea").attr("disabled");
            }

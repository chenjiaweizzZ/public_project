    ...
    <div v-loading="isLoading">
      <OperationHeader>
        ...
        <div class="width300px">
          &ensp; 患者类型&ensp;
          <el-select class="width200px" v-model="query.deptCode" placeholder="选择患者类型">
            <el-option
...
export default {
  ...
  methods: {
    ...
    handleSelectionChange(val) {
      ...
      this.radio = this.multipleSelection.serial_no
    },
    choice() {
      this.$parent.setdialogVisibleV2()
      // this.$apis.getFlupOverdueConfig().then(res => {
      //   if (res.patientAssignDoctor == '2') {
      //     // this.plan.dialogVisibleV2 = true
      //   } else {
      //     this.onAdd()
      //   }
      // })
      ...
      if (this.multipleSelection) {
        ...
        try {
          if (this.multipleSelection.planCondition) {
            ...
            //   flup_plan_id: this.plan.serial_no,

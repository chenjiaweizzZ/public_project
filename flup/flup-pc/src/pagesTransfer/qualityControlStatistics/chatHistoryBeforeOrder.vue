<template>
  <div class="chatHistoryBeforeOrder">
    <div class="headers">
      <div class="search">
        <section>
      ...
      <div class="main">
        <div class="d-table">
          <el-table :data="mainList" border stripe height="100%">
            ...
            <el-table-column show-overflow-tooltip label="创建时间" prop="serviceStartTime"></el-table-column>
            <!-- <el-table-column show-overflow-tooltip label="科室" prop="deptName"></el-table-column> -->
            <el-table-column show-overflow-tooltip label="操作" width="100">
              <template slot-scope="scope">
                <el-button type="text" @click="getRecord(scope.row)">查看</el-button>
              </template>
            </el-table-column>
          </el-table>
        </div>
  ...
  methods: {
    ...
    getGroupUserInfoList() {
      this.$apis
        ...
        .then((res) => {
          this.memberList = res;
          this.getChatHistory((this.pageNo2 = 1));
          // this.drawer = true;
        });
    },
    /**
      ...
      this.$apis
        ...
        .then((res) => {
          ...
          if (this.mainList.length > 0) {
            this.getRecord(this.mainList[0]);
          }
        });
    },
    /**
     ...
     */
    getChatHistory() {
      // console.log(this.pageNo2, 'this.pageNo2');
      this.$apis
        .getHistoryQuery({
